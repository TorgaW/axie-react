...
function TableCellComponent(props) {
  ...
  */
    ...
    let fetchingPlayerInfo = UIStore.useState((s) => s.fetchingPlayerInfo);
    ...
    return (
        <tr className="h-20 border-4 border-blue-300">
            ...
            <td
                onClick={() => {
                    console.log("fetching", fetchingPlayerInfo);
                    if (axieTable.selectedPlayer !== props.id - 1 && !fetchingPlayerInfo.a && !fetchingPlayerInfo.p) {
                        /*
            bookmark #1
            */
            ...
            <td className="flex justify-center pt-2">
                <img
                    ...
                    src={
                        /*axieTable[props.id - 1].axieAvatar*/ axieTable[props.id - 1] && axieTable[props.id - 1].avatar
                            ? "/api/getUserImage/?ronin=" + axieTable[props.id - 1].ronin
            ...
            <td className="text-green-500 font-bold">
                {props.content ? props.content.slp + " (" + (props.content.slp * slpToDollar).toFixed(2) + "$)" : "?"}
            </td>{" "}
            {/* SLP*/}
            <td>{props.content ? props.content.slpDailyLimit + " (" + (props.content.slpDailyLimit * slpToDollar).toFixed(2) + "$)" : "?"}</td>{" "}
            {/* Daily SLP Limit*/}
            <td>{props.content ? props.content.slpPerDay + " (" + (props.content.slpPerDay * slpToDollar).toFixed(2) + "$)" : "?"}</td> {/* SLP/day */}
            <td>
                {
                    (props.content ? props.content.slpManager : "?") +
                        " (" +
                        (props.content ? props.content.slpManagerPerc : "?") +
                        "%, " +
                        (props.content.slpManager * slpToDollar).toFixed(2) +
                        "$)" /*0 (0%)*/
                }
            </td>{" "}
            {/* Manager SLP */}
...
function TilesComponent() {
    ...
    let claimsReady = 0;
    let managerSlpReady = 0;
    let claimsNext = 0;
    let managerSlpNext = 0;
    let maxMMR = { p: "", s: 0 };
    ...
    for (const i of axieTable) {
        ...
        if (compareAsc(i.nextClaim, formatRFC7231(new Date())) <= 0) {
            claimsReady++;
            managerSlpReady += i.slpManager;
        } else if (isTomorrow(i.nextClaim)) {
            claimsNext += i.slp;
            managerSlpNext += i.slpManager;
        }
    }
    ...
    return (
        <div className="md:w-11/12 w-full mt-10 self-center grid grid-rows-4 grid-cols-2 md:grid-rows-2 md:grid-cols-4 gap-2">
            <div className="bg-gray-900 w-full h-40 md:h-56 rounded-lg flex flex-col p-4">
                ...
                <h3 className="w-full text-center md:text-4xl text-2xl text-white mt-auto">{totalSLP.toFixed(1)} SLP</h3>
            ...
            <div className="bg-gray-900 w-full h-40 md:h-56 rounded-lg flex flex-col p-4">
                ...
                <h3 className="w-full text-center md:text-4xl text-2xl text-white mt-auto">{totalManager.toFixed(1)} SLP</h3>
            ...
            <div className="bg-gray-900 w-full h-40 md:h-56 rounded-lg flex flex-col p-4">
                ...
                <h3 className="w-full text-center md:text-4xl text-2xl text-white mt-auto">
                    {axieTable.length ? (totalSlpPerDay / axieTable.length).toFixed(1) : "0.0"} SLP
                </h3>
            ...
            <div className="bg-gray-900 w-full h-40 md:h-56 rounded-lg flex flex-col p-4">
                ...
                <h3 className="w-full text-center md:text-4xl text-2xl text-white mt-auto">{managerSlpReady.toFixed(1)} SLP</h3>
                <h5 className="w-full text-center md:text-xl text-green-400 mt-auto">{(managerSlpReady * slpToDollar).toFixed(2)}$</h5>
            </div>
            ...
            <div className="bg-gray-900 w-full h-40 md:h-56 rounded-lg flex flex-col p-4 pb-10">
                ...
                <h3 className="w-full text-center md:text-4xl text-2xl text-white my-auto">{claimsReady}</h3>
            </div>
            <div className="bg-gray-900 w-full h-40 md:h-56 rounded-lg flex flex-col p-4">
                <h5 className="w-full text-center md:text-xl text-yellow-500">Claims in Next 24h</h5>
                <h3 className="w-full text-center md:text-4xl text-2xl text-white mt-auto">{claimsNext.toFixed(1)} SLP</h3>
                <h5 className="w-full text-center md:text-xl text-green-400 mt-auto">{(claimsNext * slpToDollar).toFixed(2)}$</h5>
            </div>
            <div className="bg-gray-900 w-full h-40 md:h-56 rounded-lg flex flex-col p-4">
                <h5 className="w-full text-center md:text-xl text-yellow-500">Manager SLP Next 24h</h5>
                <h3 className="w-full text-center md:text-4xl text-2xl text-white mt-auto">{managerSlpNext.toFixed(1)} SLP</h3>
                <h5 className="w-full text-center md:text-xl text-green-400 mt-auto">{(managerSlpNext * slpToDollar).toFixed(2)}$</h5>
            </div>
        </div>
    );
}
...
function TableControlComponent() {
    const [addingTracker, setAddingTracker] = React.useState(false);
    function AddNewPlayer() {
        ...
        if (
            ...
            alert("Error: input data is not valid");
            return;
        }
        ...
        fetch("/api/addTracker", {
            ...
            .then((data) => {
                ...
                if (data.status !== "Already added") {
                    ...
                    alert("Failed to add! Error: " + data.status);
                }
            })
            .catch((error) => {
                console.log(error);
                            ...
                            datasets: [
                                {
                                    ...
                                    data: [
                                        (
                                            (allPlayerInfo[allPlayerInfo.length - 1].slpPerDay / allPlayerInfo[allPlayerInfo.length - 1].dailySlpLimit) *
                                            100
                                        ).toFixed(1),
                                    ],
                                    fill: false,
                        ...
                        <div className="flex flex-wrap justify-center mt-4">
                            ...
                            >
                                ...
                                <div className="w-full h-6 bg-purple-100 mt-3 flex items-center">
                                    ...
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[0].parts[0].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 flex items-center">
                                    ...
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[0].parts[1].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 bg-purple-100 mt-1 flex items-center">
                                    ...
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[0].parts[2].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 flex items-center">
                                    ...
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[0].parts[3].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 bg-purple-100 flex items-center">
                                    ...
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[0].parts[4].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 flex items-center">
                                    ...
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[0].parts[5].class.toLowerCase()}
                                    >
                            ...
                            >
                                ...
                                <div className="w-full h-6 bg-purple-100 mt-3 flex items-center">
                                    <img src="part_eyes.svg" alt="eyes" width="24px" height="24px" className="ml-2" />
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[1].parts[0].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 flex items-center">
                                    <img src="part_ears.svg" alt="ears" width="24px" height="24px" className="ml-2" />
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[1].parts[1].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 bg-purple-100 mt-1 flex items-center">
                                    <img src="part_back.svg" alt="back" width="24px" height="24px" className="ml-2" />
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[1].parts[2].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 flex items-center">
                                    <img src="part_mouth.svg" alt="mouth" width="24px" height="24px" className="ml-2" />
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[1].parts[3].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 bg-purple-100 flex items-center">
                                    <img src="part_horn.svg" alt="horn" width="24px" height="24px" className="ml-2" />
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[1].parts[4].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 flex items-center">
                                    <img src="part_tail.svg" alt="tail" width="24px" height="24px" className="ml-2" />
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[1].parts[5].class.toLowerCase()}
                                    >
                            ...
                            >
                                ...
                                <div className="w-full h-6 bg-purple-100 mt-3 flex items-center">
                                    <img src="part_eyes.svg" alt="eyes" width="24px" height="24px" className="ml-2" />
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[2].parts[0].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 flex items-center">
                                    <img src="part_ears.svg" alt="ears" width="24px" height="24px" className="ml-2" />
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[2].parts[1].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 bg-purple-100 mt-1 flex items-center">
                                    <img src="part_back.svg" alt="back" width="24px" height="24px" className="ml-2" />
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[2].parts[2].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 flex items-center">
                                    <img src="part_mouth.svg" alt="mouth" width="24px" height="24px" className="ml-2" />
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[2].parts[3].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 bg-purple-100 flex items-center">
                                    <img src="part_horn.svg" alt="horn" width="24px" height="24px" className="ml-2" />
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[2].parts[4].class.toLowerCase()}
                                    >
                                ...
                                <div className="w-full h-6 flex items-center">
                                    <img src="part_tail.svg" alt="tail" width="24px" height="24px" className="ml-2" />
                                    <div
                                        className={"w-full flex font-bold justify-center items-center mr-8 " + "color-" + axies[2].parts[5].class.toLowerCase()}
                                    >
    ...
    */
    ...
    return (
        <tr className="h-16 border-4 border-blue-300">
            ...
            <td className="font-bold">{props.content.mmr ?? " "}</td> {/* ELO*/}
...
function ControlPanel(props) {
    ...
    React.useEffect(() => {
        ...
        try {
            ...
            console.log("formations after for: ", a);
        } catch {}
    }, [formations]);
    ...
    React.useEffect(() => {
        ...
        try {
            ...
            setPlayerOptions(a);
            console.log("players after for: ", a);
        } catch {}
    }, [axieTable]);
    ...
    React.useEffect(() => {
        fetch("/api/getTeams", {
            ...
            .then((data) => {
                console.log("from api/getTeams", data.status);
                try {
    ...
    React.useEffect(() => {
        fetch("/api/getFormations", {
            ...
            .then((data) => {
                console.log("from api/getFormations", data.status);
                try {
                    for (const i of data.status) {
                        if (i) {
                            UIStore.update((s) => {
    ...
    return (
        <div className="md:w-11/12 w-full mt-10 self-center">
            ...
            <div className="w-full flex items-center mt-4">
                ...
                <button
                    onClick={() => {
                        AttachPlayerToTheTeam(
                            document.getElementById("selection-player-attach-team").value,
                            document.getElementById("selection-team-attach-team").value
                        );
                    }}
                    className="rounded-lg bg-green-300 hover:bg-green-700 transition-all duration-150 p-2 font-bold ml-4 hover:text-white"
                >
            ...
            <div className="w-full flex items-center mt-4">
                ...
                <button
                    onClick={() => {
                        RemovePlayerFromTheTeam(
                            document.getElementById("selection-player-remove-team").value,
                            document.getElementById("selection-team-remove-team").value
                        );
                    }}
                ...
                <button
                    onClick={() => {
                        CreateNewFormation(
                            ...
                            document.getElementById("selection-player-new-formation").value
                        );
                    }}
                    className="rounded-lg bg-green-300 hover:bg-green-700 transition-all duration-150 p-2 font-bold ml-4 hover:text-white"
                >
...
function Dashboard() {
    ...
    React.useEffect(() => {
        if (session) {
            fetch("/api/getAllTrackedUsers", {
                ...
                .then((data) => {
                    if (data.status !== "no tracker exist" && axieTable.length === 0) {
                        console.log(data);
                        let d = data.status;
                        let final = [];
                        for (const i of d) {
                            try {
                                final.push({
                                    ...
                                    slpPerDay: i.slpPerDay >= 0 ? i.slpPerDay:0,
    ...
    function GetPlayerInfo(inRonin, newPlayer) {
        ...
        if (axieTable.length > 0 && axieTable[newPlayer] && !axieTable[newPlayer].axiesLoaded) {
            ...
            UIStore.update((s) => {
                s.fetchingPlayerInfo.p = true;
                s.fetchingPlayerInfo.a = true;
            });
            ...
            fetch("/api/getUserInfo", {
                ...
                .then((data) => {
                    ...
                    UIStore.update((s) => {
                        s.axieTable[newPlayer].axieAvatar = data.status.avatar ?? undefined;
                    });
                    setPlayerInfoLoaded(1);
                    UIStore.update((s) => {
                        s.fetchingPlayerInfo.p = false;
                    });
                })
                .catch((error) => {
                    console.log(error);
    ...
    function RefreshTable() {
        if (!isRefreshing) {
            ...
            fetch("/api/refresh", {
                ...
                .then((data) => {
                    console.log("Refresh Debug Data", data);
                    console.log('axie table', axieTable)
                    for (const i in data.status) {
                        if (Object.hasOwnProperty.call(data.status, i)) {
                            UIStore.update(s=>{
                                console.log('Update query from: ', i);
                                for (const j of s.axieTable) {
                                    if(j.name === i.toString())
                                    {
                                        j.slpPerDay = data.status[i].slpPerDay >= 0 ? data.status[i].slpPerDay:0;
                                        j.source.slpPerDay = data.status[i].slpPerDay < 0 ? data.status[i].slpPerDay:0;
                                        j.source.mmrPerDay = data.status[i].mmrPerDay;
                                        console.log('updated player:', j.name)
                                    }
                                }
                            });
                        }
                ...
                .catch((error) => {
                    console.log(error);
                    setIsRefreshing(false);
                    alert('Failed to refresh tracker! Error: ', error.message);
                });
        } else {
        ...
        <>
            ...
            <Content>
                <div className="w-full h-full flex flex-col overflow-x-hidden">
                    ...
                    <div className="w-full h-12 flex justify-center mt-10 mb-2">
                        <button
                            onClick={() => {
                    ...
                    {isRefreshing ? (
                        ...
                        <TableComponent content={axieTable} getPlayerInfo={GetPlayerInfo} />
                    ) : (
                        <ArenaTableComponent />
                    ))}
                    <div className="h-auto md:w-11/12 w-full self-center">
                        <button
                            onClick={() => {
                                RefreshTable();
                            }}
                            className="p-2 bg-green-400 mt-2 rounded-lg font-bold text-md transition-all duration-150 hover:bg-green-500 hover:text-white"
                        >
                            Refresh
                        </button>
                        {/* bookmark #123 */}
                    ...
                    {playerAxiesLoaded * playerInfoLoaded ? (
                        ...
                        axieTable[selectedPlayer].axieAvatar !== "placeholder-avatar.png"
                          ...
                          : "placeholder-avatar.png"*/
                                                axieTable[selectedPlayer] && axieTable[selectedPlayer].avatar
                                                    ? "/api/getUserImage/?ronin=" + axieTable[selectedPlayer].ronin
                                                    : "placeholder-avatar.png"
                                            }
                                            width="256px"
                                            height="256px"
                                ...
                                <div className="w-full h-full flex flex-col">
                                    <div className="w-full h-12 justify-center md:justify-start flex text-xl text-gray-600">
                                        <button
                                            ...
                                            className={
                                                "p-2 font-bold transition-all duration-150 border-b-2 " +
                                                (selectedButton === 0 ? "selected-button" : "non-selected-button")
                                            }
                                        >
                                            &nbsp;&nbsp;Axies&nbsp;&nbsp;
                                        </button>
                                        <button
                                            ...
                                            className={
                                                "p-2 font-bold transition-all duration-150 border-b-2 " +
                                                (selectedButton === 1 ? "selected-button" : "non-selected-button")
                                            }
                                        >
                                            &nbsp;&nbsp;Tracking&nbsp;&nbsp;
                                        </button>
